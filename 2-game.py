...
# 충돌 오브젝트 목록 (배경 기준 좌표)
obstacle_list = [
    pygame.Rect(1000, 420, 120, 60),  # 책상
    pygame.Rect(1600, 420, 80, 80),   # 서랍
    pygame.Rect(500, 420, 100, 100),  # 문 앞 상자
]
...
while running:
    ...
    if keys[pygame.K_a]:
        ...
        if not any(next_rect.colliderect(ob) for ob in obstacle_list):
